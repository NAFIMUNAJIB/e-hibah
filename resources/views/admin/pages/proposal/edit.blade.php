    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="min-height: 100vh">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.proposal.update', $row) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="nama_organisasi" id="nama_organisasi" type="text"
                                ...
                                value="{{ old('nama_organisasi', $row->nama_organisasi) }}">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="no_telp_organisasi" id="no_telp_organisasi" type="phone"
                                class="form-control @error('no_telp_organisasi') is-invalid @enderror"
                                value="{{ old('no_telp_organisasi', $row->no_telp_organisasi) }}">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="email_organisasi" id="email_organisasi" type="email"
                                ...
                                value="{{ old('email_organisasi', $row->email_organisasi) }}">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="alamat_organisasi" id="alamat_organisasi" type="text"
                                ...
                                value="{{ old('alamat_organisasi', $row->alamat_organisasi) }}">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="peruntukan" id="peruntukan" type="text"
                                ...
                                value="{{ old('peruntukan', $row->peruntukan) }}">
                            @error('peruntukan')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="tanggal_pengajuan" id="tanggal_pengajuan" type="date"
                                ...
                                value="{{ old('tanggal_pengajuan', $row->tanggal_pengajuan) }}">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input required name="nilai" id="nilai" type="text"
                                ...
                                value="{{ old('nilai', idrFormat($row->nilai)) }}">
                            @error('nilai')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select name="tahapan" id="tahapan" class="form-control">
                                <option @if ($row->tahapan == 'daftar') selected @endif value="daftar">Daftar</option>
                                <option @if ($row->tahapan == 'verifikasi') selected @endif value="verifikasi">
                                    Verifikasi Proposal</option>
                                <option @if ($row->tahapan == 'pengecekan proposal') selected @endif value="pengecekan proposal">
                                    Pengecekan Proposal</option>
                                <option @if ($row->tahapan == 'evaluasi') selected @endif value="evaluasi">Evaluasi
                                </option>
                                <option @if ($row->tahapan == 'ditolak') selected @endif value="ditolak">Ditolak</option>
                            </select>
                            @error('tahapan')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-12 col-md-7">
                            ...
                            <input name="lampiran" id="lampiran" type="file"
                                ...
                                value="{{ old('lampiran', $row->lampiran) }}" accept=".pdf">
                            @error('lampiran')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
